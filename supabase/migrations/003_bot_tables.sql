...
('installments', 'التقسيط', 'תשלומים',
 'تقسيط بسعر الكاش حتى 18 دفعة عبر حوالة بنكية. بدون فوائد. البنوك المقبولة: هبوعليم، لئومي، ديسكونت، مزراحي طفحوت، البنك الدولي، يهاف، مركنتيل، أوتسار هحيال، الاتحاد، مساد، القدس، دكسيا، بوعلي أغودات، البنك العربي الإسرائيلي. لا نقبل بنك الدواء.',
 '/legal', 4),
