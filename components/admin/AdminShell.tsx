...
const NAV_ITEMS = [
  ...
  { key: "appliances", href: "/admin/appliances", icon: "🛋️", label: "أجهزة ذكية" },
  { key: "tvs", href: "/admin/tvs", icon: "📺", label: "تلفزيونات" },
  { key: "computers", href: "/admin/computers", icon: "💻", label: "كمبيوتر" },
  { key: "tablets", href: "/admin/tablets", icon: "📱", label: "تابلت" },
  { key: "network", href: "/admin/network", icon: "📡", label: "شبكة" },
  { key: "import-excel", href: "/admin/import-excel", icon: "📥", label: "استيراد Excel" },
